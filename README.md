...
This ansible role installs and configures the New Relic Server Agent (System Monitor Daemon). This was formerly owned by [`sivel`](https://github.com/sivel/). This is a cached copy.
